#
#  Be sure to run `pod spec lint ALPValidator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of ALPValidator in Markdown format.
  ...
  s.author             = { "Adam Waite" => "email@address.com" }
  # s.authors          = { "Adam Waite" => "email@address.com", "other author" => "email@address.com" }
  # s.author           = 'Adam Waite', 'other author'
